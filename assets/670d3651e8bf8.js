...
console.log("Elucidat.com Rapid Authoring (v.#build_version#) built with love on 2024-10-14 03:10:19");
/* 
notes - to add:
    1.2
        cmi.core.student_id
...
Elucidat.prototype._set_initial_page_visited_state = function ( page, history ) {
    ...
    setTimeout(function () {
        ...
        try {
            if(m && m._endpoint_data && m._endpoint_data.history) {
                m._endpoint_data.history = history.h;
            }
            if(endpoint && Object.hasOwn(endpoint, 'current')) {
                endpoint.current = 'pages/'+history.c;
            }
        } catch (e) {
            console.error('Error setting local history', e);
        }
...
// load a url
Elucidat.prototype._load_href = function (url, options) {
...
Elucidat.prototype.load = function () {
    ...
    c._load_href(
        c.options.homepage_url,
        {
            timeout: 5000,
            complete: function (status, statusText, responses, responseHeaders) {
                if(statusText == "timeout") {
                    c.navigating = 'tryAgain';
                    const firstPage = c.page_order[0]
                    const urlWithoutPage = c.options.homepage_url.split('/').slice(0, -1).join('/')
                    const extension = c.options.homepage_url.split('.').pop()
                    const firstPageUrl = `${urlWithoutPage}/${firstPage}.${extension}`
                    c._load_href( firstPageUrl );
                }
            },
        }
    );
...
window.NAVIGATION_OBJECT={"template":"<li class=\"menu__item {{page.is_section}} {{page.active}} e-no-controls\">\n    <a href=\"{{page.url}}\" class=\"itemInner menu__item__inner\" title=\"{{page.name}}\" data-dismiss=\"dropdown\">\n        <span class=\"icon\">\n            <i class=\"ti ti-lock\"><span class=\"focusHelper\"><\/span><\/i>\n        <\/span>\n        <span class=\"text e-no-controls\">{{page.name}}<\/span>\n    <\/a>\n    {{page.sub_pages}}\n<\/li>","url_format":"pages\/%s.js","pages":{"6649f785544e8":{"n":"Welcome","mn":false,"mod":false,"hol":false,"sec":true,"i":true,"s":1,"b":"_664a17b0a5410","v":"viewed","d":true},"6649f7b0a541e":{"n":"Introduction","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"l":1,"b":"_664a1bd66c086","v":"viewed-all","p":"6649f785544e8"},"6649f7bb7fa44":{"n":"Objectives","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664a1d4a39bb2","v":"viewed","p":"6649f785544e8"},"6649f7caa8a82":{"n":"Recall","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664a1e977ef7b","v":"viewed","p":"6649f785544e8"},"6649f7dd8d5f0":{"n":"Setting up an Influencing Strategy: Assessing Digital Influencing Priorities","mn":false,"mod":false,"hol":false,"sec":true,"i":true,"s":1,"l":1,"b":"_66e28b3420d46","v":"viewed-all","d":true},"6649f7fb73805":{"n":"Stakeholder Mapping","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664a4195b376d","v":"viewed","p":"6649f7dd8d5f0"},"6649f80b30faf":{"n":"Supporter Profiling","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664b17a6530cf","v":"viewed","p":"6649f7dd8d5f0"},"6649f81ad70fd":{"n":"Supporter Engagement","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664b1da178969","v":"viewed","p":"6649f7dd8d5f0"},"6649f8285a40c":{"n":"Tactics","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664b7d236b91c","v":"viewed","p":"6649f7dd8d5f0"},"6649f834e6b73":{"n":"Case Studies","mn":false,"mod":false,"hol":false,"sec":true,"i":true,"s":1,"b":"_6649fcbed4566","v":"viewed","d":true},"6649f84b1b135":{"n":"Case Study 1","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"l":1,"b":"_664a0961e2596","v":"viewed-all","p":"6649f834e6b73"},"664a0690e3807":{"n":"Case Study 2","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"l":1,"b":"_664a09389cafb","v":"viewed-all","p":"6649f834e6b73"},"6649f87cd56bd":{"n":"Conclusion","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"l":1,"b":"_664a12dd9e646","v":"viewed-all","p":"6649f834e6b73"},"6649f88d93bd3":{"n":"Assessment","mn":false,"mod":false,"hol":false,"sec":true,"i":true,"s":1,"b":"_664b97ebce8f8","v":"viewed","d":true},"6649f8a20d26c":{"n":"Questions","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"c":1,"b":"_66fa6fab7a902","v":"correct-score","p":"6649f88d93bd3"},"6649f8ccf0a47":{"n":"Fail","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664c425221581","r":"(result == fail)","v":"viewed","p":"6649f88d93bd3"},"6649f8d78e63d":{"n":"Congratulations","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_664c45d996531","r":"(result == pass)","v":"viewed","p":"6649f88d93bd3"}}}
$('body').on('elucidat.page.ready', function (event, page_data, $new_page) {
     ...
     */
    var $languageToggleButton = $('[data-role="e-lang-toggle"]');
    if(!$languageToggleButton.length) {
        return;
    }
    if(m && m._endpoint_data && m._endpoint_data.menu && m._endpoint_data.menu.length) {
        $languageToggleButton.off('click');
        $languageToggleButton.on('click', function () {
            $("body").find('#pew').remove();
            window.m.createMenu();
        })
    } else {
        $languageToggleButton.attr('disabled', 'disabled');
        $languageToggleButton.off('click');
        $languageToggleButton.on('click', function (event) {
            event.preventDefault();
            event.stopPropagation();
        })
    }
